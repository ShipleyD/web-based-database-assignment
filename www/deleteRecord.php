			...
			if ($connection->connect_error){
					die('Connect Error :   ' . $connection->connect_error);
						...
						if ($error) {
								...
								$query = "DELETE FROM grocery_inventory WHERE item_name = '$s_item_name'";
							
								
								//run the query and display appropriate message
								if (!$result = $connection->query($query)) {
										$message .="Unable to delete rows<br />";
									}
									else {
											$message .= "Row Successfully deleted<br />";
										}
							}
					}
	...
	<section id="content">
		<div class="container">
			<section id="introp" class="cf">
				<div class="grid-full">
					<h1 class="heading">Delete Record Example</h1>
				</div>
			</section>
		</div>
			<section id="grid" class="clearfix">
				<div class="grid-full">
					<h2 class="sub-heading">SQL Delete Example</h2>
				</div>
				<div class="cf show-grid">
					...
					<form action="deleteRecord.php" method="post" name="maint" id="maint">
					<div class="row">
						<div class="grid-half">
							<h1>Select Record</h1>
							<p><?php echo $message; ?><p>
								...
								<fieldset class="maintform">
									...
									<ul>
										<li><label for="s_item_name">Item to be Deleted</label><br />
									...
									<a class="cancel" href="deleteRecord.php">Cancel</a>
								</fieldset>
